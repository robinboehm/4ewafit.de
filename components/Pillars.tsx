...
export default function Pillars() {
  return (
    <section id="angebote" className="py-12 sm:py-16 px-4 sm:px-6 bg-dark-bg text-white">
      <div className="max-w-5xl mx-auto">
        <p className="text-xs font-bold text-brand uppercase tracking-widest mb-2">Mein Ansatz</p>
        <h2 className="text-2xl sm:text-3xl font-black tracking-tight leading-tight text-white mb-3">
          Drei Säulen.<br />Ein Ziel: Du.
        </h2>
        <p className="text-sm text-gray-400 leading-relaxed max-w-xl mb-8 sm:mb-10">
