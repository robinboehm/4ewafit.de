...
export default function Hero() {
  return (
    <section className="relative min-h-[500px] sm:min-h-[560px] flex items-end overflow-hidden">
      <Image
        src={IMAGES.heroBg}
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-5 sm:px-8 pb-10 sm:pb-14 pt-10">
        ...
        <div className="flex gap-5 sm:gap-7">
          <div>
            <div className="text-xl sm:text-2xl font-black text-white leading-none">50×</div>
            <div className="text-xs text-white/50 uppercase tracking-widest mt-0.5">⭐ Bewertungen</div>
          </div>
          <div>
            <div className="text-xl sm:text-2xl font-black text-white leading-none">15 J.</div>
            <div className="text-xs text-white/50 uppercase tracking-widest mt-0.5">Erfahrung</div>
          </div>
          <div>
            <div className="text-xl sm:text-2xl font-black text-white leading-none">Eigenes</div>
